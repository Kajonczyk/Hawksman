...
export const SecondSection = () => {
  return (
    <StyledWrapper>
      ...
      <StyledDecoratedText>
        A new kind of estate agent. You get a quality service 100% of the time.
        We don’t hire ‘door openers’ for weekend viewings.
      </StyledDecoratedText>
      <StyledNumbersWrapper>
        <StyledNumber>1</StyledNumber>
        <StyledText>
          You get an experienced member of the team showing your property every
          time someone goes to see it.
        </StyledText>
      </StyledNumbersWrapper>
      <StyledNumbersWrapper>
      ...
      <StyledNumbersWrapper>
        ...
        <StyledText>
          ...
          transparent advice. We are a completely personal service where each
          client and project is dealt with entirely on its own characteristics.
        </StyledText>
      </StyledNumbersWrapper>
      <StyledNumbersWrapper>
